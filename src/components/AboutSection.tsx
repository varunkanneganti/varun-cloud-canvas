          ...
          <div className="card-modern p-8 md:p-12 animate-fade-in-up">
            <div className="prose prose-lg max-w-none">
              <p className="text-lg leading-relaxed text-foreground mb-6">
                ...
                working at <span className="font-semibold text-primary">Signitives</span> as a Product Intern, 
                I'm actively exploring the synergy between product thinking and robust cloud engineering.
              </p>
              
              <p className="text-lg leading-relaxed text-foreground">
                Previously, I worked as a Java Intern at Arnisys LLC, where I built and optimized 5+ REST APIs 
                with Spring Boot, improving response times by 30% and achieving 90%+ test coverage using JUnit and Mockito. 
